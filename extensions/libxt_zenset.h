#ifndef _LIBXT_ZENSET_H
#define _LIBXT_ZENSET_H
...
get_version(unsigned *version)
{
	...
	if (res != 0)
		xtables_error(OTHER_PROBLEM,
			      "Kernel module xt_zenset is not loaded in.\n");
...
static void
get_set_byname_only(const char *setname, struct xt_zenset_info *info,
...
static void
get_set_byname(const char *setname, struct xt_zenset_info *info)
{
...
static void
parse_dirs(const char *opt_arg, struct xt_zenset_info *info)
{
